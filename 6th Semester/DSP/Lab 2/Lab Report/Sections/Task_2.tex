...
\begin{figure}[ht]
    ...
    \includegraphics[width=6cm, height=5cm]{Delta.jpg}
\end{figure}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=6cm, height=5cm]{Unity.jpg}
\end{figure}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=6cm, height=5cm]{Unitramp.jpg}
\end{figure}
\end{document}